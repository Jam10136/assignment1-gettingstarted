...
def welcome_assignment_answers(question):
    ...
    if question ==  "In Slack, what is the secret passphrase posted in the #lab-python-getting-started channel posted by a TA?":
        ...
        answer = "defb0ec48041f811d7641c2950ca38915226cf778254e1651ad58472dfcfa6db"
        ...
        answer = "Yikes...It looks like the question isn't properly written. Fix itttt!"
    return(answer)
...
if __name__ == "__main__":
    ...
    #going to use the debug_question as an array to step through each question (will copy directly from the Questions section below to make sure I don't have any typos.
    ...
    #trying to loop through the questions
    for question in debug_question:
        print(question), print(welcome_assignment_answers(question))
